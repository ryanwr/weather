...
public class WeatherProvider {
    ...
    public void getCurrentWeather(final ResponseCallback<CurrentWeather> callback, double lon, double lat) {
        Call<CurrentWeatherResponse> response = weatherService.getCurrentWeather(lon, lat);
